        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="bg-white p-4 rounded-lg border">
            ...
            <div className="text-2xl font-bold text-green-600">
              +
              {(
                ((exchangeRates.cripto - exchangeRates.oficial) /
        ...
        <div className="mt-4 p-4 bg-yellow-100 rounded-lg">
          <div className="flex items-start space-x-2">
            ...
            <div className="text-sm text-yellow-800">
              <strong>Importante:</strong> Los métodos crypto tienen mayor
              complejidad operativa y riesgos adicionales. Para montos menores a
              USD 1,000/mes, el método bancario tradicional suele ser más
              conveniente.
            </div>
          </div>
        </div>
